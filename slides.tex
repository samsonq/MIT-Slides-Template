...
\title{MIT Slides Template}
\author{Samson Qian}
\institute[]{Massachusetts Institute of Technology}
\date{\today}
% \pgfdeclareimage[height=0.7cm]{mit-logo}{mit-logo.pdf}
% \logo{\pgfuseimage{mit-logo}\hspace*{0.7cm}}
\pgfdeclareimage[height=0.7cm]{sloan}{sloan.pdf}
\logo{\pgfuseimage{sloan}\hspace*{0.7cm}}
